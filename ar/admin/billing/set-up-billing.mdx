...
<AccordionGroup>
  ...
  <Accordion title="Why do some users not receive invoices automatically?">
    ...
    - **No company manager assigned:** إذا كان من المفترض إرسال الفاتورة إلى شركة، فتأكد من تعيين [**مدير شركة**](/admin/customer-management/companies/company-members-and-managers). بدون ذلك، يتم إنشاء الفاتورة ولكن لا يتم تسليمها إلى أي شخص.
  </Accordion>
</AccordionGroup>
