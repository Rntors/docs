...
3. إذا كان نشاطك التجاري يقع في بلد يتطلب تفاصيل بنكية أو تفاصيل دفع إضافية، فاملأ حقول الفوترة ذات الصلة أو تذييل الفاتورة. يمكنك أيضًا [تكوين فواتير QR-bill](/admin/billing/invoices/qr-bill).
...
2. [حدد **Billing cycle anchor** الخاص بك](/admin/billing/subscriptions/billing-cycle-anchor).
3. [إدارة **Auto-remove members**](/admin/customer-management/users/remove-users#auto-remove-members).
...
2. إذا كانت دولتك هي بلجيكا أو إسبانيا، فيمكنك تمكين [eInvoicing](/admin/billing/invoices/einvoicing/overview).
3. اختر "Invoice type":
   - **Invoice** — ستحمل جميع الفواتير والرسائل الإلكترونية ذات الصلة عنوان "Invoice".
   - [**Proforma invoice**](/admin/billing/invoices/proforma-invoices) — ستحمل جميع الفواتير والرسائل الإلكترونية ذات الصلة عنوان "Proforma invoice".
...
5. استخدم حقل [**Advance invoicing**](/admin/billing/subscriptions/advance-invoicing) لجدولة عدد الأيام التي يجب أن يتلقى فيها العملاء الفواتير قبل تاريخ تجديد اشتراكهم. وهو مفيد إذا كنت تريد أن يتلقى العملاء فواتيرهم ويسددوها قبل بدء فترة اشتراكهم التالية.
6. حدد عدد أيام **Payment due** بعد تاريخ إصدار الفاتورة. تحسب RNTOR تلقائيًا تاريخ استحقاق كل فاتورة وتحدده. يمكنك [تخصيص استحقاق الدفع](/admin/billing/invoices/invoice-due-date) للفواتير الفردية.
7. إدارة [Payment retries and reminders](/admin/billing/invoices/payment-retries-and-reminders).
...
9. في حقل **Accounting email**، أضف البريد الإلكتروني الوارد لنظام المحاسبة الخاص بك. سيتم إرسال جميع الفواتير والإيصالات من هذا الموقع إلى هذا البريد الإلكتروني. [التكامل مع تطبيق المحاسبة الخاص بك](/admin/billing/invoices/accounting).
...
2. إذا لزم الأمر، [**أضف عملة (عملات) بديلة**](/admin/billing/currencies) إلى جانب عملة موقعك الرئيسية. يمكنك بعد ذلك تطبيقها لتحويل الفواتير والمشتريات لجميع العملاء أو لعملاء محددين.
...
<AccordionGroup>
  ...
  <Accordion title="Why do some users not receive invoices automatically?">
    ...
    - **Paused payment collection:** [**قد يتم إيقاف تحصيل المدفوعات مؤقتًا**](/admin/billing/subscriptions/control-invoice-issuance) لاشتراك العميل، مما يعني أنه لن يتم إصدار فواتيره تلقائيًا.
    - **No company manager assigned:** إذا كان من المفترض إرسال الفاتورة إلى شركة، فتأكد من تعيين [**مدير شركة**](https://www.spacebring.com/docs/customer-management/company-members-and-managers). بدون ذلك، يتم إنشاء الفاتورة ولكن لا يتم تسليمها إلى أي شخص.
  </Accordion>
</AccordionGroup>
