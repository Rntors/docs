...
<AccordionGroup>
  <Accordion title="Is there a limit to how much I can ask?">
    RNTOR MCP supports normal conversational use. If a request is temporarily limited, wait briefly and try again.
  </Accordion>

  <Accordion title="Can I connect RNTOR MCP to more than one AI assistant or account at the same time?">
    Yes. Each assistant or account connects independently, so multiple authorized connections can be used at the same time and disconnected separately.
  </Accordion>
</AccordionGroup>