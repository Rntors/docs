...
<Frame>
  <img src="/images/developer-light.png" alt="Developers Tab" className="block dark:hidden" />
  <img src="/images/developer-dark.png" alt="Developers Tab" className="hidden dark:block" />
</Frame>
