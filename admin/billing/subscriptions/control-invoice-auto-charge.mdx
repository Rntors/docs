...
2. A customer has a recurring [**subscription**](/admin/billing/subscriptions/set-up-subscriptions).
3. A customer has a [**default payment method**](/admin/billing/payments/payment-methods).
...
<AccordionGroup>
  <Accordion title="What should I do if the customer's invoice wasn't auto-charged?">
    ...
    1. Go to the customer profile and ensure they have a [**payment method added**](/admin/billing/payments/payment-methods).
    2. Then, open the unpaid invoice and click [**Charge**](/admin/billing/invoices/record-invoice-payments) to retry the payment instantly.
  </Accordion>
</AccordionGroup>