...
<Tip>
  The member web portal and mobile app are designed to empower users to make bookings effortlessly on their own without needing administrator assistance. [Promote self-served bookings](/guides/promotion/promote-self-served-bookings) for a more efficient user experience.
</Tip>
...
<Frame>
  <img src="/images/billing-payments-external-1.png" alt="Select a customer as the booking booker in RNTOR" />
</Frame>
...
<Frame>
  <img src="/images/billing-payments-external-2.png" alt="Create a booking for a new nonmember in RNTOR" />
</Frame>

5. Fill out the other booking details.
6. If the user is eligible for any discount, [select a coupon](/admin/billing/discounts/apply-discounts-to-bookings-and-purchases) in the **Coupon** section. The discounted price will be displayed immediately.
...
<Frame>
  <img src="/images/billing-payments-external-3.png" alt="Mark an external booking payment as paid in RNTOR" />
</Frame>
...
* The system immediately generates an [invoice](/admin/billing/invoices/download-an-invoice) and [receipt](/admin/billing/payments/receipts) for the customer.
...
<Frame>
  <img src="/images/billing-payments-external-6.png" alt="Update the status of an external transaction in RNTOR" />
</Frame>
