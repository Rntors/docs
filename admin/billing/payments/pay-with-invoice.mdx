...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-enable-pay-with-invoice.png)" />
</Frame>
...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-2.png)" />
</Frame>
...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-4.png)" />
</Frame>
...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-5.png)" />
</Frame>
...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-6.png)" />
</Frame>
...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-7.png)" />
</Frame>

5. In the **Payment** section, select **Personal invoice** or **Company invoice** > press **Book**. 

<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-8.png)" />
</Frame>
...
4. Click **Create invoice** under the **Pending invoice items** section to generate a draft invoice.
   <Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-manage-pending-invoice-items.png)" />
</Frame>
