...
<Frame>
  <img src="/images/billing-payments-pay-with-invoice-enable-pay-with-invoice.png" alt="Enable personal invoice payments for selected services in RNTOR" />
</Frame>
...
<Frame>
  <img src="/images/billing-payments-pay-with-invoice-2.png" alt="Add personal invoice purchases to subscription invoices in RNTOR" />
</Frame>
...
<Frame>
  <img src="" alt="Upload the matching RNTOR screenshot (images/billing-payments-pay-with-invoice-3.png)" />
</Frame>
...
<Frame>
  <img src="/images/billing-payments-pay-with-invoice-4.png" alt="Keep personal invoice purchases separate from subscription invoices in RNTOR" />
</Frame>
...
<Frame>
  <img src="/images/billing-payments-pay-with-invoice-5.png" alt="Choose Personal invoice as a payment method in RNTOR" />
</Frame>
...
<Frame>
  <img src="/images/billing-payments-pay-with-invoice-6.png" alt="Select the booking customer in RNTOR" />
</Frame>
...
<Frame>
  <img src="/images/billing-payments-pay-with-invoice-7.png" alt="Select New nonmember in the RNTOR Booker menu" />
</Frame>

5. In the **Payment** section, select **Personal invoice** or **Company invoice** > press **Book**. 

<Frame>
  <img src="/images/billing-payments-pay-with-invoice-8.png" alt="Create a booking as a pending personal invoice item in RNTOR" />
</Frame>
...
4. Click **Create invoice** under the **Pending invoice items** section to generate a draft invoice.
   <Frame>
  <img src="/images/billing-payments-pay-with-invoice-manage-pending-invoice-items.png" alt="Manage pending invoice items in a customer profile in RNTOR" />
</Frame>
