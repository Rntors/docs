...
| External                                                                                                                                    | *X*                                                | ✓                                         |
| [Stripe](/admin/integrations/payments/stripe)<br />[KakaoPay](/admin/integrations/payments/kakaopay)<br />[WayForPay](/admin/integrations/payments/wayforpay) | ✓<br />Yes, if enabled in the integration settings | ✓                                         |
| [Other payment gateways](/admin/integrations/payments)                                                                                            | *X*                                                | *X*                                       |
...
2. Go to **Integrations** > open your payment gateway's page ([Stripe](/admin/integrations/payments/stripe), [WayForPay](/admin/integrations/payments/wayforpay), or [KakaoPay](/admin/integrations/payments/kakaopay)).
...
2. [Add a new event](/admin/engagement/events) or [edit an existing one](/admin/engagement/events#edit-an-event).
...
* Give a [promo code](/admin/billing/discounts/give-and-apply-discounts#create-promo-codes) with the appropriate discount to encourage future purchases.
...
<Accordion title="Why don't I see a Refund button to issue a refund to a customer via RNTOR?">
  The **Refund** button in RNTOR is only available if the payment gateway integration you use supports refunds directly from RNTOR: [Stripe](/admin/integrations/payments/stripe), [WayForPay](/admin/integrations/payments/wayforpay), or [KakaoPay](/admin/integrations/payments/kakaopay).

  For [other payment gateways](/admin/integrations/payments) that don't support refund initiation via RNTOR, the **Refund** button isn't available. You'll need to [issue the refund manually from the payment gateway's dashboard](/admin/billing/payments/refunds#issue-refunds-via-payment-gateway-dashboard) instead.
</Accordion>
