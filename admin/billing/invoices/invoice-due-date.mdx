...
1. Go to **RNTOR > Customers** > open the user or company > click on the subscription > press [**View upcoming invoice**](#replace-upcoming-invoice-link) or [**create a one-off invoice**](#replace-create-one-off-invoice-link).
...
- When [**creating a subscription**](#replace-create-subscription-link) for the user, the administrator can set a custom payment due date for the upcoming invoice if necessary.
```
