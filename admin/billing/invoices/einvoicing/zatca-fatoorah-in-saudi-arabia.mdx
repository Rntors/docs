...
5. Go to **Location settings > Billing > Currencies**.
   ...
   - If your primary location currency is different, [**add SAR, Saudi Riyal as an alternative currency**](/admin/billing/currencies) and apply it to all customer profiles for which you want to generate eInvoices.
...
1. Go to **Location settings > Customers** and configure the [**Require billing details**](/admin/customer-management/billing-details) setting based on your needs:
...
2. To review or update customer details manually:
   ...
   - Go to **Customers**, open the customer profile, and locate the [**Billing details**](/admin/customer-management/billing-details) section on the right-side panel. Administrators can complete any missing billing details there.
   - Alternatively, ask customers to update their own billing details under [**Membership > Billing**](/member/account/billing).
...
- When eInvoicing is enabled, voiding invoices and credit notes is not supported because ZATCA does not allow it. Instead, you can:
  ...
  - [**Issue a credit note**](/admin/billing/invoices/credit-notes) to correct the invoice.
...
You can also view the eInvoice synchronization status for all invoices in the [**Invoices report**](/admin/analytics-reports/reports).
