...
Your [location billing details](/admin/customer-management/billing-details) must be complete and accurate.
...
Each customer must also have accurate [billing details](/admin/customer-management/billing-details).
...
- [Credit notes](/admin/billing/invoices/credit-notes) are also submitted if their original invoice was successfully synced.
...
You can also see eInvoice sync status for all invoices from the [**Invoices** page](/admin/billing/invoices/track-and-manage-invoices).