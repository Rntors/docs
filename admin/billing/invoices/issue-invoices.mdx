...
description: "Learn how to automatically issue recurring invoices for memberships and rentals, or manually create one-off invoices for custom charges with RNTOR"
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
1. The customer completes the purchase through the member web portal or mobile app and [pays through a payment gateway](/admin/billing/payments/payment-gateway).
2. Alternatively, an administrator can create a one-off booking for the customer using the [External payment method](/admin/billing/payments/external).
...
<Frame>
  <img
    src="https://mintlify.s3.us-west-1.amazonaws.com/rntor/images/billing/issue-invoices/create-invoice.png"
    alt="Create an invoice from a customer profile in RNTOR"
  />
</Frame>
...
<Frame>
  <img
    src="https://mintlify.s3.us-west-1.amazonaws.com/rntor/images/billing/issue-invoices/new-invoice-item.png"
    alt="Add an item to a new invoice in RNTOR"
  />
</Frame>
...
<Frame>
  <img
    src="https://mintlify.s3.us-west-1.amazonaws.com/rntor/images/billing/issue-invoices/issue-invoice.png"
    alt="Issue or issue and charge an invoice in RNTOR"
  />
</Frame>
