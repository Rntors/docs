...
Whenever a customer, or an administrator on their behalf, makes a booking or purchase using the [**Invoice payment method**](/admin/billing/payments/pay-with-invoice), it is recorded as a pending invoice item. How and when pending invoice items are billed depends on:
...
<Frame>
  ![Chat GPT Image Jul 27, 2026, 04 38 01 PM](/images/ChatGPT-Image-Jul-27,-2026,-04_38_01-PM.png "Chat GPT Image Jul 27, 2026, 04 38 01 PM")
</Frame>
...
2. Bookings for dates within the current period and other purchases (shop products, event tickets, credit packages) are added to the [**Upcoming invoice**](/admin/billing/invoices/upcoming-invoices).
