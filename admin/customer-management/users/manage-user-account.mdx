...
<Info>
  **Default privacy settings** are set by the owner, but the user can change their own privacy settings and override them, which may make their personal information visible to others.
</Info>

4. To **manage their payment methods**, users go to **Membership → Billing → "Payment methods"** section.
5. To **manage their billing details**, users go to **Membership → Billing** and update the legal business name, address, and tax ID.
...
3. In the right-hand panel:
   ...
   - Click on `Edit` next to the "Billing details" section and **manage the user's billing details.**
