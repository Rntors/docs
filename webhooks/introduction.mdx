...
<Tip>
  Start with a few key events and add more as your integration grows. See all available events at [webhooks.rntor.com](https://webhooks.rntor.com/).
</Tip>
...
<CardGroup cols={2}>
  <Card title="Verifying webhooks requests" icon="shield" href="/webhooks/security">
    Implement signature verification
  </Card>
  <Card title="Webhook event types" icon="list" href="https://webhooks.rntor.com/">
